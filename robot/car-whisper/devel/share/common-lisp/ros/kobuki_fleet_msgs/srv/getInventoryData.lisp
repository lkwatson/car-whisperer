...
;//! \htmlinclude getInventoryData-request.msg.html

(cl:defclass <getInventoryData-request> (roslisp-msg-protocol:ros-message)
  ((start
    :reader start
    :initarg :start
...
(cl:defclass getInventoryData-request (<getInventoryData-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <getInventoryData-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'getInventoryData-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kobuki_fleet_msgs-srv:<getInventoryData-request> is deprecated: use kobuki_fleet_msgs-srv:getInventoryData-request instead.")))

(cl:ensure-generic-function 'start-val :lambda-list '(m))
(cl:defmethod start-val ((m <getInventoryData-request>))
...
(cl:defmethod object-val ((m <getInventoryData-request>))
...
(cl:defmethod actual_station-val ((m <getInventoryData-request>))
  ...
  (actual_station m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <getInventoryData-request>) ostream)
  "Serializes a message object of type '<getInventoryData-request>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <getInventoryData-request>) istream)
  "Deserializes a message object of type '<getInventoryData-request>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<getInventoryData-request>)))
  "Returns string type for a service object of type '<getInventoryData-request>"
  "kobuki_fleet_msgs/getInventoryDataRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'getInventoryData-request)))
  "Returns string type for a service object of type 'getInventoryData-request"
  "kobuki_fleet_msgs/getInventoryDataRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<getInventoryData-request>)))
  "Returns md5sum for a message object of type '<getInventoryData-request>"
  "d0359135eac7dfdadf776963b7cda6a8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'getInventoryData-request)))
  "Returns md5sum for a message object of type 'getInventoryData-request"
  "d0359135eac7dfdadf776963b7cda6a8")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<getInventoryData-request>)))
  "Returns full string definition for message of type '<getInventoryData-request>"
  (cl:format cl:nil "std_msgs/Bool start~%std_msgs/String object~%std_msgs/String actual_station~%~%================================================================================~%MSG: std_msgs/Bool~%bool data~%================================================================================~%MSG: std_msgs/String~%string data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'getInventoryData-request)))
  "Returns full string definition for message of type 'getInventoryData-request"
  (cl:format cl:nil "std_msgs/Bool start~%std_msgs/String object~%std_msgs/String actual_station~%~%================================================================================~%MSG: std_msgs/Bool~%bool data~%================================================================================~%MSG: std_msgs/String~%string data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <getInventoryData-request>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <getInventoryData-request>))
  "Converts a ROS message object to a list"
  (cl:list 'getInventoryData-request
    (cl:cons ':start (start msg))
    (cl:cons ':object (object msg))
    (cl:cons ':actual_station (actual_station msg))
))
;//! \htmlinclude getInventoryData-response.msg.html

(cl:defclass <getInventoryData-response> (roslisp-msg-protocol:ros-message)
  ((station_height
...
(cl:defclass getInventoryData-response (<getInventoryData-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <getInventoryData-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'getInventoryData-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kobuki_fleet_msgs-srv:<getInventoryData-response> is deprecated: use kobuki_fleet_msgs-srv:getInventoryData-response instead.")))

(cl:ensure-generic-function 'station_height-val :lambda-list '(m))
(cl:defmethod station_height-val ((m <getInventoryData-response>))
...
(cl:defmethod material_type-val ((m <getInventoryData-response>))
...
(cl:defmethod brightness-val ((m <getInventoryData-response>))
...
(cl:defmethod threshold_1-val ((m <getInventoryData-response>))
...
(cl:defmethod threshold_2-val ((m <getInventoryData-response>))
...
(cl:defmethod filter_size-val ((m <getInventoryData-response>))
...
(cl:defmethod filter-val ((m <getInventoryData-response>))
...
(cl:defmethod laserScan-val ((m <getInventoryData-response>))
...
(cl:defmethod pose-val ((m <getInventoryData-response>))
...
(cl:defmethod finished-val ((m <getInventoryData-response>))
  ...
  (finished m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <getInventoryData-response>) ostream)
  "Serializes a message object of type '<getInventoryData-response>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <getInventoryData-response>) istream)
  "Deserializes a message object of type '<getInventoryData-response>"
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <getInventoryData-response>))
  "Converts a ROS message object to a list"
  (cl:list 'getInventoryData-response
...
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'getInventoryData)))
  'getInventoryData-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'getInventoryData)))
  'getInventoryData-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'getInventoryData)))
  "Returns string type for a service object of type '<getInventoryData>"
  "kobuki_fleet_msgs/getInventoryData")